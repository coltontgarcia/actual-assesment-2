...
const canWeDeliver = (zipCode) => {
    for(let i = 0; i < deliveryAreaZipCodes.length; i++) {
        if(zipCode == deliveryAreaZipCodes[i]) return "You're in our deliver zone!"
        }
  return "Sorry, you are outside of our delivery zone, please refer to another location."
}
...
const canWeDeliverTwo = (zipCode) => {
    if(deliveryAreaZipCodes.includes(zipCode)) return "You're in our deliver zone!"
    else return "Sorry, we can't deliver to houses outside of out delivery zone." 
}

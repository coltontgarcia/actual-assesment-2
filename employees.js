...
class Employee {
    ...
    getSchedule() {
        console.log(`${this.name} is only working during ${this.shifts}.`)
    }
}
...
let empOne = new Employee('Colton', ['weekend mornings','weekend evenings'])
...
let manager = new Manager('Jeddy', ['weekday mornings', 'weekday afternoons'], ['James', 'Charles'])
...
manager.addEmployee('Mr. bossman')
